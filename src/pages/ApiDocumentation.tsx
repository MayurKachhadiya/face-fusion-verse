...
const ApiDocumentation = () => {
  ...
  const Parameter = ({ name, type, required, description }: { 
    ...
    <div className="border-b pb-3 mb-3 last:border-b-0">
      <div className="flex items-center gap-2 mb-1">
        <code className="bg-gray-100 px-2 py-1 rounded text-sm font-mono">{name}</code>
  ...
  const StatusCode = ({ code, description }: { code: string; description: string }) => (
    <div className="flex items-start gap-3 mb-3">
      <code className="bg-gray-100 px-2 py-1 rounded text-sm font-mono min-w-fit">{code}</code>
      <p className="text-gray-600 text-sm">{description}</p>
    </div>
  );
      ...
      <SidebarProvider>
        <div className="flex w-full pt-16">
          ...
          <Sidebar className="w-64 border-r bg-white">
            <SidebarContent>
              <SidebarGroup>
                <SidebarGroupLabel className="px-4 py-2 text-sm font-semibold text-gray-900">
                  API Documentation
                </SidebarGroupLabel>
                <SidebarGroupContent>
                  <SidebarMenu>
            ...
            <ScrollArea className="h-screen">
              <div className="max-w-4xl mx-auto p-8">
                ...
                <section id="overview" className="mb-12">
                  <h1 className="text-4xl font-bold mb-4">FaceSwap AI API Documentation</h1>
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <p className="mb-4">Get started with our API in three simple steps:</p>
  ...
  headers: {
    ...
    'Content-Type': 'application/json'
                ...
                <section id="single-face-swap" className="mb-12">
                  <h2 className="text-3xl font-bold mb-6">Single Face Swap API</h2>
...
const response = await fetch('https://api.faceswap.ai/v1/face-swap/single', {
  ...
  body: formData
                      ...
                      <h4 className="font-semibold mb-3 mt-6">Example Response</h4>
                      <CodeBlock
                        language="json"
                        code={`{
  "id": "fs_1234567890",
  ...
  "webhook_url": "https://your-app.com/webhook"
                  ...
                  <Card>
                    <CardHeader>
                      <CardTitle>Get Single Face Swap Result</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <p className="mb-4">
  ...
  "expires_at": "2024-01-22T10:30:00Z"
                ...
                <section id="multiple-face-swap" className="mb-12">
                  <h2 className="text-3xl font-bold mb-6">Multiple Face Swap API</h2>
...
const response = await fetch('https://api.faceswap.ai/v1/face-swap/multiple', {
  ...
  "webhook_url": "https://your-app.com/webhook"
                  ...
                  <Card>
                    <CardHeader>
                      <CardTitle>Get Multiple Face Swap Result</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <p className="mb-4">
                        <Badge className="mr-2">GET</Badge>
  ...
  "request_id": "req_1234567890"
                      ...
                      <h4 className="font-semibold mb-3 mt-6">Common Error Codes</h4>
                      <div className="space-y-3">
                        <div>
                          <code className="bg-gray-100 px-2 py-1 rounded text-sm font-mono">INVALID_API_KEY</code>
                          <p className="text-gray-600 text-sm mt-1">The provided API key is invalid or expired</p>
                        </div>
                        <div>
                          <code className="bg-gray-100 px-2 py-1 rounded text-sm font-mono">INSUFFICIENT_CREDITS</code>
                          <p className="text-gray-600 text-sm mt-1">Your account doesn't have enough credits for this operation</p>
                        </div>
                        <div>
                          <code className="bg-gray-100 px-2 py-1 rounded text-sm font-mono">NO_FACE_DETECTED</code>
                          <p className="text-gray-600 text-sm mt-1">No faces were detected in the uploaded image</p>
                        </div>
                        <div>
                          <code className="bg-gray-100 px-2 py-1 rounded text-sm font-mono">PROCESSING_FAILED</code>
                          <p className="text-gray-600 text-sm mt-1">Face swap processing failed due to technical issues</p>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
